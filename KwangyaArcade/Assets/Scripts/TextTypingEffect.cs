...
public class TextTypingEffect : MonoBehaviour
{
    ...
    void ChangeScene()
    {
        ...
        if (curScene == "2.Mini1_ot")
            SceneManager.LoadScene("Bisibasi_1");
        else if (curScene == "3.Mini2_ot")
            SceneManager.LoadScene("Bisibasi_2");
        else if (curScene == "4.Mini3_ot")
            SceneManager.LoadScene("Bisibasi_3");
        else if (curScene == "5.Jet_ot")
            SceneManager.LoadScene("JetGame");
        else if (curScene == "6.Tetris_ot")
